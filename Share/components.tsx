...
export const MyButton = ({title = "Отмена",
                          onPress = () => {},
                          style = {
                                   height: 'auto',
                                   size: 1,
...
export const CustomModalWindow = (props: alertProps) => {
    const {
        ...
        message = "Вы уверены?",
        buttons = [
    {title: "Отмена", onPress: () => {}, style: {backgroundColor: '#8C8888', color: '#b22000',fontSize: 18, size:  2}},
    {title: "Подтвердить", onPress: () => {}, style: {backgroundColor: '#8C8888', color: '#0cc213',fontSize: 18, size:  2}}]
    }: alertProps = props;
    let btns: any = []
